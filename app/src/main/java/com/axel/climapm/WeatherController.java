...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "0809ac21c9486ecca19726c959b7ac22";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeCityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WeatherController.
                        this,ChangeCityController.class){
                };
    ...
    private void getCurrentWeatherLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d(LOGCAT_TAG, "onLocationChanged() lon " + longitude);
                Log.d(LOGCAT_TAG, "onLocationChanged() lat " + latitude);
                Log.d(LOGCAT_TAG, "onLocationChanged() appid " + APP_ID);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if(requestCode == REQUEST_CODE){
            if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Log.d(LOGCAT_TAG,"onRequestPermissionResult() granted");
            }else{
                Log.d(LOGCAT_TAG,"onRequestPermissionResult() denied");
            }
        }
    }
